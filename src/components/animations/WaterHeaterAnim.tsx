    ...
    <div className="relative w-full h-72 md:h-96 rounded-2xl overflow-hidden bg-navy-deep border border-amber/10 flex items-center justify-center">
      <svg viewBox="0 0 360 280" className="w-full h-full" aria-label="Solar water heater animation">
        ...
        <g transform="translate(280,55)">
          {[0,40,80,120,160,200,240,280,320].map((angle, i) => (
            <line key={i} x1="0" y1="-26" x2="0" y2="-36"
              stroke="#FBB034" strokeWidth="2" strokeLinecap="round"
          ...
          <circle r="20" fill="#FBB034" opacity="0.9"/>
        </g>

        {/* Evacuated tube collector */}
        <g transform="translate(60,70)">
          {/* Frame */}
          <rect width="180" height="110" rx="4" fill="#221608" stroke="#FBB034" strokeWidth="0.8"/>
          {/* Tubes */}
          {[0,1,2,3,4,5].map(i => {
            const cx = 20 + i * 28
            return (
              <g key={i}>
                ...
                {/* Steam */}
                {animated && (
                  <text x={cx} y="8" textAnchor="middle" fill="#FBB034" fontSize="8" opacity="0">
                    〜
        ...
        <g transform="translate(260,90)">
          <ellipse cx="36" cy="10" rx="30" ry="8" fill="#221608" stroke="#FBB034" strokeWidth="0.8"/>
          <rect x="6" y="10" width="60" height="100" fill="#221608" stroke="#FBB034" strokeWidth="0.8"/>
          <ellipse cx="36" cy="110" rx="30" ry="8" fill="#221608" stroke="#FBB034" strokeWidth="0.8"/>
          {/* Water level */}
          ...
          {/* Temp readout */}
          <text x="36" y="42" textAnchor="middle" fill="#FBB034" fontSize="11" fontFamily="monospace" fontWeight="bold">62°C</text>
          {/* Pipe */}
          <line x1="6" y1="80" x2="-20" y2="80" stroke="#D4920A" strokeWidth="3" strokeLinecap="round"/>
          <circle cx="-20" cy="80" r="4" fill="#FBB034" opacity="0.8"/>
        </g>
        ...
        {animated && (
          <circle r="3" fill="#FBB034" opacity="0.9">
        ...
        <g transform="translate(20,200)">
          <rect x="0" y="0" width="70" height="40" rx="6" fill="#221608" stroke="#FBB034" strokeWidth="0.7"/>
          <text x="35" y="15" textAnchor="middle" fill="#9A8870" fontSize="7" fontFamily="monospace">HOT WATER</text>
          <text x="35" y="30" textAnchor="middle" fill="#FBB034" fontSize="11" fontFamily="monospace" fontWeight="bold">24/7 ☀</text>
        </g>

        <defs>
          <linearGradient id="heatGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stopColor="#FBB034" stopOpacity="0.8"/>
            <stop offset="100%" stopColor="#D4920A" stopOpacity="0.3"/>
          </linearGradient>
          <linearGradient id="waterGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stopColor="#FBB034" stopOpacity="0.5"/>

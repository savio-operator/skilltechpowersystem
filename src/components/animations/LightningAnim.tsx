  ...
  return (
    <div className="relative w-full h-72 md:h-96 rounded-2xl overflow-hidden bg-[#080600] border border-amber/10">
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <polygon points="90,5 10,45 170,45" fill="#1A1105" stroke="#FBB034" strokeWidth="0.8" opacity="0.5"/>
        ...
        {/* Arrester rod */}
        <line x1="90" y1="5" x2="90" y2="-8" stroke="#FBB034" strokeWidth="1.5" strokeLinecap="round"/>
        <circle cx="90" cy="-8" r="2.5" fill="#FBB034"/>
      </svg>
      ...
      {shouldReduce && (
        <div className="absolute inset-0 flex items-center justify-center">
          <svg width="60" height="100" viewBox="0 0 60 100" fill="none" aria-label="Lightning bolt">
            <path d="M38 5 L18 50 H32 L22 95 L52 42 H38 L48 5 Z" fill="#FBB034" opacity="0.9"/>
          </svg>
        </div>
      )}
    </div>

  ...
  return (
    <main className="min-h-screen bg-navy-deep pt-24">
      <div className="max-w-3xl mx-auto px-6 md:px-10 py-16">
        <Link href="/" className="font-mono text-xs text-warm-grey hover:text-amber transition-colors mb-8 block">
          ← Back
        </Link>
        ...
        <a
          href={`https://wa.me/${SITE.whatsapp.number}?text=Hi%2C%20I%27m%20interested%20in%20solar%20installation.`}

  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family:sans-serif;max-width:520px;background:#f9f9f9;border-radius:8px;padding:24px">
        <h2 style="margin:0 0 16px;color:#1A2B4A">New solar enquiry — Skilltech Power System</h2>
        <table style="font-size:14px;line-height:1.8;width:100%">
          ...
          <tr><td style="color:#888;padding:4px 0">Phone</td><td><a href="tel:${phone}" style="color:#1A2B4A">${phone}</a></td></tr>

    ...
    <div className="relative w-full h-72 md:h-96 rounded-2xl overflow-hidden bg-navy-deep border border-amber/10 flex items-center justify-center">
      <svg viewBox="0 0 360 260" className="w-full h-full" aria-label="Solar panel maintenance animation">
        ...
        {[0,1,2,3].map((i) => {
          ...
          return (
            <g key={i} transform={`translate(${x}, 60)`}>
              <rect width="60" height="96" rx="3" fill="#1a2a05" stroke="#FFFFFF" strokeWidth="0.8"/>
              {/* Cell grid */}
              {[0,1,2,3].map(r => (
              ...
              {animated && (
                <ellipse cx="12" cy="12" rx="6" ry="3" fill="#FFFFFF" opacity="0">
        ...
        <g transform="translate(290,100)">
          {/* Body */}
          <circle cx="15" cy="10" r="8" fill="#2A1C05" stroke="#FFFFFF" strokeWidth="0.8"/>
          ...
          {/* Tablet/meter */}
          <rect x="32" y="13" width="14" height="10" rx="2" fill="#221608" stroke="#FFFFFF" strokeWidth="0.8"/>
          <rect x="34" y="15" width="10" height="6" rx="1" fill="#FFFFFF" opacity="0.4"/>
          {/* Legs */}
        ...
        <g transform="translate(14,12)">
          <rect width="90" height="44" rx="6" fill="#221608" stroke="#FFFFFF" strokeWidth="0.7" opacity="0.95"/>
          <text x="8" y="18" fill="#9A8870" fontSize="7" fontFamily="monospace">PERFORMANCE</text>
          <text x="8" y="30" fill="#FFFFFF" fontSize="11" fontFamily="monospace" fontWeight="bold">94.2%</text>
